...
import {Form, Button, DatePicker, Input, Modal, Radio, Select, Steps, Dropdown, Menu} from 'antd';
...
const StepForm: React.FC<UpdateFormProps> = (props) => {
  ...
  const renderContent = () => {
    ...
    return (
      <>
        ...
        >
          <Input placeholder="表类型" />
        </FormItem>
        <FormItem
          name="className"
          label="Java类名"
        >
          <Input placeholder="Java类名" />
        </FormItem>
        <FormItem
          name="parentTable"
          label="主表表名"
        >
          <Input placeholder="主表表名" />
        </FormItem>
        <FormItem
          name="refPk"
          label="外键"
        >
          <Input placeholder="外键" />
        </FormItem>
